...
public class LottoGame {
	 private final LottoNumberGenerator generator;
	    ...
	    // 생성자를 통해 의존성 주입(서브클래스에서 객체를 생성하게하는 간단한 팩토리 패턴)
	    public LottoGame(LottoNumberGenerator generator, LottoUserInput userInput, 
	                     LottoComparator comparator, LottoResultDisplayImp display) {
